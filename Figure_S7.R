...
# rm(list=ls())
# opar <- par()
setwd("~/Box Sync/T1D Tmr Heterogeneity/bd tree/Cpept Age Modeling/")
...
data.CyTOF <-
  readxl::read_xlsx(
    "allSubjectsSummary_Compiled_10K_Samples_3_Metas_with_Age_Rapid_vs_Slow_for_Matt_Plus_Total_CD8_180918.xlsx",
    sheet=1, skip=1) %>%
